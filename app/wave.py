...
class Wave:
	...
	def __init__(self, ctx, x, y, w, h):
		...
		self.sample = 0.002  # 	default sample
	...
	def add(self, window):
		...
		#	there's a big buffer of samples and
		#	it needs to be shift them over 2 at a time upon every call
		#	and then ake room for two more (an upper (-) and lower (+))
